...
\section{Úvod}
V tejto práci je riešená implementácia diskrétneho systému, ktorá bude použitá na modelovanie zaplnenia domovov pre seniorov a s ním spojené starnutie obyvateľstva. %Na základe modelu a simulačných experimentov bude znázornené chovanie systému vzhľadom na ... //treba dokoncit 
